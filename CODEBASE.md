...
- Enabled selectable markdown text for both assistant and user messages (`MarkdownBody.selectable`), removed inline `Copy` buttons, and added a double-tap/double-click detector that copies the full text block to clipboard.
