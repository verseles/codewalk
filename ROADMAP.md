...
Enabled selectable assistant text (including desktop double-click selection and native copy menu behavior) and removed the dedicated assistant copy button to simplify message actions.
